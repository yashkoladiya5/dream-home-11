              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoTile(
                    ...
                    onTap: () => context.push('/withdraw-history'),
                  ),
                  const SizedBox(height: 12),
                  _buildInfoTile(
                    context,
                  ...
                  _buildInfoTile(
                    context,
                    label: 'Winners History',
                    value: 'VIEW',
                    valueColor: AppTheme.primaryRed,
                    icon: Icons.emoji_events_rounded,
                    onTap: () => context.push('/winners'),
                  ),
                  const SizedBox(height: 12),
                  _buildInfoTile(
                    context,
                  ...
                  _buildInfoTile(
                    ...
                    onTap: () => context.push('/responsible-gaming'),
                  ),
                  const SizedBox(height: 12),
                  _buildInfoTile(
                    context,
