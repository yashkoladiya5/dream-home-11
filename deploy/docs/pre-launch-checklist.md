...
> Status: ❌ Not Started | ✅ Complete | ⚠️ Needs Review
...
- [ ] **Firebase restricted to authorized domains**
...
- [ ] **Environment variables checked for hardcoded secrets**
...
- [ ] **Query performance reviewed (slow query log)**
...
- [ ] **Payment webhook verified with test transaction**
...
- [ ] **App version check mechanism active**
...
- [ ] **DNS records correct (api., admin., cdn.)**
