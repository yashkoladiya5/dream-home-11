...
describe('Production Smoke Tests', () => {
  describe('Health Endpoints', () => {
    ...
    test.skip(
      'GET /health/ready returns 200 (DB + Redis up)',
      async () => {
  ...
  describe('API Endpoints', () => {
    test.skip(
      'GET /api/v1/contests returns 200 with paginated response',
      async () => {
    ...
    test.skip(
      'GET /api/v1/users/dashboard returns 401 without auth',
      async () => {
    ...
    test.skip(
      'OPTIONS /api/v1/contests returns 200 with CORS headers',
      async () => {
    ...
    test.skip(
      'POST /api/v1/auth/verify-otp returns 400 for invalid body',
      async () => {
        const res = await api()
  ...
  describe('Response Time Compliance', () => {
    ...
    test.skip.each(endpoints)(
      '$method $url responds within ${MAX_RESPONSE_TIME}ms',
      async ({ method, url }) => {
